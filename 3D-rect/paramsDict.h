...
float	q1, q2;
float	SIGMA, cwidth, cheight, uemax, ownL0, size_domm, rho1_val, rho2_val, mu1_val, mu2_val;
float	oxc, oyc, ozc;
float	DTi, nMaxDT;
int		startSteps;
...
{
	&NCells, &maxRlevel,
	&q1, &q2, &SIGMA, &cwidth, &cheight, &uemax, &ownL0, &size_domm, &rho1_val, &rho2_val, &mu1_val, &mu2_val,
